    ...
    <div className="border border-gray-200 rounded-xl bg-white shadow-sm overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          <svg className="w-3.5 h-3.5 text-brand-copper" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="px-3 pb-3">
          ...
          {loading ? (
            <div className="flex items-center gap-2 text-xs text-gray-400 py-2">
              <span className="w-3 h-3 border-2 border-brand-copper border-t-transparent rounded-full animate-spin flex-shrink-0" />
